...
router.route('/list').post(authMiddleware_js_1.default, clickUp_controller_js_1.getLists);
router.route('/task').post(authMiddleware_js_1.default, clickUp_controller_js_1.getTasks);
